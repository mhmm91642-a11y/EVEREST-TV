        ...
        <div className="max-w-2xl mx-auto">
          <div className="glass rounded-lg p-12 text-center">
            ...
            <Button
              ...
              size="lg"
              className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold px-8 py-6 text-lg glow smooth-transition"
            >
