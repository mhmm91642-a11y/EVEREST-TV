        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className={`space-y-8 ${language === "ar" ? "md:text-right" : "md:text-left"}`}>
            ...
            <div className={`flex gap-4 flex-wrap ${language === "ar" ? "flex-row-reverse" : ""}`}>
              <Button
                size="lg"
                className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold px-8 py-6 text-lg glow smooth-transition shadow-lg hover:shadow-2xl"
              >
                {t.hero.subscribeBtn}
              </Button>
              <Button
                ...
                className="bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white font-bold px-8 py-6 text-lg smooth-transition shadow-lg hover:shadow-2xl border-2 border-cyan-400"
              >
