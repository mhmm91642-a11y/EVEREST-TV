    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a href="#devices" className="text-foreground hover:text-primary smooth-transition">
            {language === "ar" ? "الأجهزة" : "Devices"}
          </a>
          <a href="#faq" className="text-foreground hover:text-primary smooth-transition">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`px-3 py-1 rounded-md smooth-transition ${
                language === "ar"
          ...
          <Button
            ...
            variant="default"
            className="hidden md:flex gap-2 bg-green-600 hover:bg-green-700"
          >
          ...
          <button
            ...
            className="md:hidden p-2 hover:bg-muted rounded-md smooth-transition"
          >
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <nav className="md:hidden bg-card border-t border-border p-4 space-y-3">
          <a
            href="#features"
